...
- [ ] T01 | HIGH | Add PATCH /factories/:id/capacity endpoint — accepts { available_units, available_from, price_override_usd } — updates pricing_rules table; also add GET /factories/:id/capacity to read current declared capacity
